...
{
    public class GetCompteurEquipementByIdCompteurHandler : IRequestHandler<GetCompteurEquipementByIdCompteurQuery, ResponseBase<List<CompteurEquipementResponse>>>
    {
        ...
        public GetCompteurEquipementByIdCompteurHandler(
        ...
        public async Task<ResponseBase<List<CompteurEquipementResponse>>> Handle(GetCompteurEquipementByIdCompteurQuery request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var Compteur = await _CompteurQueryRepository.GetCompteurEquipementByIdCompteur(request.Id);
                if (Compteur == null)
                {
                    responseBase.IsSuccess = false;
