...
{
    public class GetReadQuery : IRequest<ResponseBase<ReadResponse>>
    {
        ...
        public GetReadQuery() { }
        public GetReadQuery(string? port, string? serialport, string? AddressIp, string? ClientAddress, string? SerialNumber, string? interfaceType, string? Objects)
        {
            this.port = port;
